...
def test_add_lr_to_scholarship_success_0(app, client, auth, scholarships):
    """
    ...
    response = client.post(
        "api/scholarships/1/location_requirements", json=json)
    ...
    with app.app_context():
        ...
        assert scholarship.location_requirements.count() == 1

        location = scholarship.location_requirements.first()
...
def test_add_lr_to_scholarship_success_1(app, client, auth, scholarships):
    """
...
def test_add_lr_to_scholarship_success_2(app, client, auth, scholarships):
    """
...
def test_add_lr_to_scholarship_success_3(app, client, auth, scholarships):
    """
    ...
    with app.app_context():
        ...
        assert scholarship.location_requirements.count() == 2

        location = scholarship.location_requirements.filter_by(id=2).first()

        assert location.zip_code == json["zip_code"]
        assert location.blacklist == True


def test_add_lr_to_scholarship_success_4(app, client, auth, scholarships):
    """
    Adds location requirement with Adress zip_code and blacklist.
...
def test_add_lr_to_scholarship_failure_0(app, client, auth, scholarships):
    """No data provided or bad structure."""

    auth.login()

    response = client.post("api/scholarships/1/location_requirements", json={})
...
def test_add_lr_to_scholarship_failure_1(app, client, auth, scholarships):
    """Missing fields."""
...
def test_add_lr_to_scholarship_failure_2(app, client, auth, scholarships):
...
def test_add_lr_to_scholarship_failure_3(app, client, auth, scholarships):
...
def test_add_lr_to_scholarship_failure_4(app, client, auth, scholarships):
...
def test_add_lr_to_scholarship_failure_5(app, client, auth, scholarships):
...
def test_add_lr_to_scholarship_failure_6(app, client, auth, scholarships):

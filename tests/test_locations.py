...
def test_location_requirements(app, client, scholarship_id):
  ...
  response = client.post(
      f"/scholarships/{scholarship_id}/states",
      json={"location_fips": [alabama["fips_code"], alaska["fips_code"]]})

  assert response.status_code == 200
  assert response.get_json()["message"] == "Locations added"

  response = client.get(f"/scholarships/{scholarship_id}/states")
...
def test_counties_requirement(app, client, scholarship_id):
  ...
  response = client.post(
      f"/colleges/{college_id}/counties",
      json={
          "location_fips": [
  ...
  response = client.get(f"/colleges/{college_id}/counties")
  ...
  response = client.post(
      f"/scholarships/{scholarship_id}/counties",
      json={
          "location_fips": [
              counties[0]["fips_code"], counties[1]["fips_code"]
          ]
  ...
  response = client.get(f"/scholarships/{scholarship_id}/counties")
...
def test_location_places(app, client, scholarship_id):
  ...
  response = client.post(
      f"/colleges/{college_id}/places",
      json={"location_fips": [places[0]["fips_code"], places[1]["fips_code"]]})

  assert response.status_code == 200
  assert response.get_json()["message"] == "Locations added"

  response = client.get(f"/colleges/{college_id}/places")
  ...
  response = client.post(
      f"/scholarships/{scholarship_id}/places",
      json={"location_fips": [places[0]["fips_code"], places[1]["fips_code"]]})

  assert response.status_code == 200
  assert response.get_json()["message"] == "Locations added"

  response = client.get(f"/scholarships/{scholarship_id}/places")
...
def test_location_consolidated_cities(app, client, scholarship_id):
  ...
  response = client.post(
      f"/colleges/{college_id}/consolidated_cities",
      json={
          "location_fips": [
  ...
  response = client.get(f"/colleges/{college_id}/consolidated_cities")
  ...
  response = client.post(
      f"/scholarships/{scholarship_id}/consolidated_cities",
      json={
          "location_fips": [
              consolidated_cities[0]["fips_code"],
              consolidated_cities[1]["fips_code"]
  ...
  response = client.get(f"/scholarships/{scholarship_id}/consolidated_cities")
